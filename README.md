...
> ✅ **Important:** Ensure JavaScript API calls point to `http://127.0.0.1:5000/`
...
`easy` · `medium` · `hard` · `good first issue` · `bug` · `feature` · `documentation` · `help wanted`

---

## 🔍 Pull Request Rules

1. PRs must be linked to an assigned issue
2. Code must be original and plagiarism-free
3. Low-effort, spam, or duplicate PRs will be rejected
4. Admin may request changes before approval
5. Only merged PRs are considered valid contributions
